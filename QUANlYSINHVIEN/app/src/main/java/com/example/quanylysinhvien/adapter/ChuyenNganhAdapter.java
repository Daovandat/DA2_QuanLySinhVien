...
public class ChuyenNganhAdapter extends BaseAdapter implements Filterable {
   // Filterable một kiểu thư viện cho phép vừa hiển thị danh sách đồng thời truy vấn, tìm kiếm các dữ liệu trong cơ sở dữ liệu
    Activity context;
    int layout;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.imageViewhinh.setImageResource(R.drawable.utehy);
        return convertView;
    }
}
